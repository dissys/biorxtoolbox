...
import org.virtualparts.VPRUtil;
import org.virtualparts.sbol.*;


public class MolSim6 {
	...
	public static void main2 (String[] args) throws Exception
	{
		...
		SBMLWriter.write(sbmlDoc, "abcomm.xml" ,' ', (short) 2);   
	...
	public static void main (String[] args) throws Exception
	{
		...
		bioSign.createModel("MolSim6_strong_test.xml", 0, bShift, total_duration, aValues, bValues);
