...
public class App 
{
    public static void main( String[] args )
    {
        try {
            ...
            /*List<Object> output=TimeSeriesSimulator.timeCourseSimulation3(FOLDER_PATH + "/MolSim7_strong.xml", 1000, total_duration);
    		    		
    		TimeSeriesSimulator.writeCsv(new File(FOLDER_PATH + "/timeCourseResult.csv"), (String[][])output.get(1));
    		
    		TimeSeriesSimulator.writeCsv(new File(FOLDER_PATH + "/timeCourseLabels.csv"), (String[][])output.get(0));    		
    		*/
